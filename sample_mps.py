#-*- coding:utf-8 -*-
from diffusion_model.trainer_mps import GaussianDiffusion, num_to_groups
...
if torch.backends.mps.is_available():
    ...
    print("MPS device found. Using MPS for sampling.")
elif torch.cuda.is_available():
    device = torch.device("cuda")
    print("CUDA device found. Using CUDA for sampling.")
else:
    device = torch.device("cpu")
    print("No GPU acceleration available. Using CPU for sampling.")
